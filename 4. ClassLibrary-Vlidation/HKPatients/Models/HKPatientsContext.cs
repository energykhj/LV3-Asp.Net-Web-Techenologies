...
{
    public partial class HKPatientsContext : DbContext
    {
        public HKPatientsContext()
        {
        }

        public HKPatientsContext(DbContextOptions<HKPatientsContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("HKPatientConnection");
                //optionsBuilder.UseSqlServer("DefaultConnection");

                //#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                //                optionsBuilder.UseSqlServer("Server=DESKTOP-BFT6VHA\\SQLEXPRESS;Initial Catalog=Patients;Integrated Security=True;");
            }
        }
