...
namespace HKPatients.Controllers
{
    ...
    public class HKCountriesController : Controller
    {
        ...
        // GET: HKCountries/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: HKCountries/Create
